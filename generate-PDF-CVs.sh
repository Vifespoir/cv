...
wkhtmltopdf -s A4 --image-dpi 200 -B 0 -L 0 -R 0 -T 2.5 $BASEDIR/tmp-en.html $BASEDIR/cv-pouget-en.pdf
...
echo 'INFO: converting html to pdf'
wkhtmltopdf -s A4 --image-dpi 200 -B 0 -L 0 -R 0 -T 2.5 $BASEDIR/tmp-es.html $BASEDIR/cv-pouget-es.pdf
...
echo 'INFO: converting html to pdf'
wkhtmltopdf -s A4 --image-dpi 200 -B 0 -L 0 -R 0 -T 2.5 $BASEDIR/tmp-fr.html $BASEDIR/cv-pouget-fr.pdf
